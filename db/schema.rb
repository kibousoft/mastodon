...
ActiveRecord::Schema.define(version: 20170606062830) do
  ...
  create_table "statuses", id: :bigint, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string   "uri"
    t.integer  "account_id",                                           null: false
    ...
    t.integer  "application_id"
    t.text     "spoiler_text",           limit: 65535,                 null: false
